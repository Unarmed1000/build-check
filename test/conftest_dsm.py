...
@pytest.fixture
def mock_dsm_analysis_results_simple(
    mock_dsm_graph_simple: Any,
    mock_dsm_metrics_simple: Dict[str, DSMMetrics]
) -> DSMAnalysisResults:
    ...
    sorted_headers = sorted(
        mock_dsm_metrics_simple.keys(),
        key=lambda h: mock_dsm_metrics_simple[h].coupling,
        reverse=True
    )

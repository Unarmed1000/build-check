...
class TestApplyExcludeFilters:
    ...
    def test_apply_exclude_single_pattern(self) -> None:
        ...
        filtered, excluded_count, no_matches, stats = apply_exclude_filters(headers, exclude_patterns, project_root)
    ...
    def test_apply_exclude_multiple_patterns(self) -> None:
        ...
        headers = {"/project/src/Engine.hpp", "/project/ThirdParty/lib.hpp", "/project/test/Test.hpp", "/project/src/Helper.hpp"}

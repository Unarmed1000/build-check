...
class TestMapHeadersToLibraries:
    ...
    def test_map_multiple_headers(self) -> None:
        ...
        headers = {
            "/project/LibA/include/header1.hpp",
            "/project/LibA/include/header2.hpp",
            "/project/LibB/source/header3.hpp",
        }
...
class TestAnalyzeCrossLibraryDependencies:
    ...
    def test_all_intra_library_deps(self) -> None:
        ...
        header_to_headers = {
            'libA/h1.hpp': {'libA/h2.hpp'},
            'libA/h2.hpp': {'libA/h3.hpp'},
            'libA/h3.hpp': set(),
        }
    ...
    def test_cross_library_deps(self) -> None:
        ...
        header_to_headers = {
            'libA/h1.hpp': {'libB/h1.hpp', 'libA/h2.hpp'},
            'libA/h2.hpp': set(),
            'libB/h1.hpp': {'libC/h1.hpp'},
            'libC/h1.hpp': set(),
        }
    ...
    def test_worst_offenders_sorting(self) -> None:
        ...
        header_to_headers = {
            'libA/h1.hpp': {'libB/h1.hpp', 'libB/h2.hpp', 'libB/h3.hpp'},
            'libA/h2.hpp': {'libB/h1.hpp'},
            'libA/h3.hpp': set(),
        }
    ...
    def test_to_dict_conversion(self) -> None:
        ...
        analysis = CrossLibraryAnalysis(
            total_deps=10,
            intra_library_deps=7,
            cross_library_deps=3,
            library_violations={'libA.a': {'libB.a': 2}},
            worst_offenders=[('header1.hpp', 5)]
        )
...
class TestFindUnusedLibraries:
    ...
    def test_some_unused_libraries(self) -> None:
        ...
        lib_to_libs = {
            'libA.a': set(),
            'libB.a': {'libA.a'},
            'libC.a': set(),  # Not used by anyone
            'libD.a': set(),  # Not used by anyone
        }
...
class TestCrossLibraryAnalysisDataclass:
    ...
    def test_dataclass_creation(self) -> None:
        ...
        analysis = CrossLibraryAnalysis(
            total_deps=100,
            intra_library_deps=80,
            cross_library_deps=20,
            library_violations={'libA.a': {'libB.a': 10}},
            worst_offenders=[('header.hpp', 5)]
        )
    ...
    def test_dataclass_to_dict_complete(self) -> None:
        ...
        analysis = CrossLibraryAnalysis(
            total_deps=50,
            intra_library_deps=30,
            cross_library_deps=20,
            library_violations=violations,

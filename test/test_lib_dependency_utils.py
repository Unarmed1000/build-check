...
class TestComputeHeaderCooccurrence:
    ...
    def test_basic_cooccurrence(self) -> None:
        ...
        source_to_deps = {"main.cpp": ["main.cpp", "foo.h", "bar.h", "baz.h"], "test.cpp": ["test.cpp", "foo.h", "bar.h"], "util.cpp": ["util.cpp", "baz.h"]}
    ...
    def test_targeted_cooccurrence(self) -> None:
        ...
        dependency_map = SourceDependencyMap(source_to_deps)
        result = compute_header_cooccurrence(dependency_map, is_header, is_system, target_headers=["foo.h"])
    ...
    def test_system_header_filtering(self) -> None:
        ...
        source_to_deps = {"main.cpp": ["main.cpp", "foo.h", "/usr/include/stdio.h", "bar.h"], "test.cpp": ["test.cpp", "foo.h", "/usr/include/stdlib.h"]}
    ...
    def test_empty_target_headers(self) -> None:
        ...
        dependency_map = SourceDependencyMap(source_to_deps)
        result = compute_header_cooccurrence(dependency_map, is_header, is_system, target_headers=[])
    ...
    def test_no_headers(self) -> None:
        ...
        source_to_deps = {"main.cpp": ["main.cpp"], "test.cpp": ["test.cpp"]}
...
class TestComputeHeaderCooccurrenceFromDepsLists:
    ...
    def test_basic_functionality(self) -> None:
        ...
        deps_by_target = {"main.o": ["main.cpp", "foo.h", "bar.h"], "test.o": ["test.cpp", "foo.h", "baz.h"]}
        ...
        result = compute_header_cooccurrence_from_deps_lists(dependency_map, is_header, is_system, show_progress=False)
    ...
    def test_progress_logging(self) -> None:
        ...
        deps_by_target = {f"target{i}.o": ["source.cpp", "header.h"] for i in range(200)}
        ...
        dependency_map = SourceDependencyMap(deps_by_target)
        result = compute_header_cooccurrence_from_deps_lists(dependency_map, is_header, is_system, show_progress=True)
...
class TestFindDependencyFanout:
    ...
    def test_basic_fanout(self) -> None:
        ...
        dependency_map = SourceDependencyMap(source_to_deps)
        result = find_dependency_fanout(target_headers=["foo.h"], dependency_map=dependency_map, is_header_filter=is_header, is_system_filter=is_system)
    ...
    def test_multiple_target_headers(self) -> None:
        ...
        source_to_deps = {"main.cpp": ["main.cpp", "foo.h", "bar.h"], "test.cpp": ["test.cpp", "foo.h", "baz.h"], "util.cpp": ["util.cpp", "bar.h", "baz.h"]}
        ...
        result = find_dependency_fanout(
            target_headers=["foo.h", "bar.h"], dependency_map=dependency_map, is_header_filter=is_header, is_system_filter=is_system
        )
    ...
    def test_empty_target_headers(self) -> None:
        ...
        dependency_map = SourceDependencyMap(source_to_deps)
        result = find_dependency_fanout(target_headers=[], dependency_map=dependency_map, is_header_filter=is_header, is_system_filter=is_system)
    ...
    def test_system_header_filtering(self) -> None:
        ...
        source_to_deps = {"main.cpp": ["main.cpp", "foo.h", "/usr/include/stdio.h", "bar.h"]}
...
class TestBuildReverseDependencyMap:
    ...
    def test_basic_reverse_map(self) -> None:
        ...
        source_to_deps = {"main.cpp.o": ["main.cpp", "foo.h", "bar.h"], "test.cpp.o": ["test.cpp", "foo.h", "baz.h"], "util.cpp.o": ["util.cpp", "bar.h"]}
    ...
    def test_no_object_extension(self) -> None:
        ...
        source_to_deps = {"main.cpp": ["main.cpp", "foo.h"], "test.cpp": ["test.cpp", "foo.h"]}
    ...
    def test_custom_header_extensions(self) -> None:
        ...
        source_to_deps = {"main.cpp.o": ["main.cpp", "foo.hh", "bar.hpp"], "test.cpp.o": ["test.cpp", "baz.hxx"]}
    ...
    def test_empty_dependencies(self) -> None:
        ...
        source_to_deps = {"main.cpp.o": ["main.cpp"]}
    ...
    def test_no_headers_in_deps(self) -> None:
        ...
        source_to_deps = {"main.cpp.o": ["main.cpp", "other.cpp"]}
...
class TestComputeAffectedSources:
    ...
    def test_basic_affected_sources(self) -> None:
        ...
        header_to_sources = {"foo.h": {"main.cpp", "test.cpp"}, "bar.h": {"main.cpp", "util.cpp"}, "baz.h": {"other.cpp"}}
    ...
    def test_header_with_no_dependents(self) -> None:
        ...
        header_to_sources = {"foo.h": {"main.cpp"}, "orphan.h": set()}  # No dependents
    ...
    def test_header_not_in_map(self) -> None:
        ...
        header_to_sources = {"foo.h": {"main.cpp"}}
    ...
    def test_sorted_output(self) -> None:
        ...
        header_to_sources = {"foo.h": {"z.cpp", "a.cpp", "m.cpp"}}
    ...
    def test_multiple_headers_overlapping_sources(self) -> None:
        ...
        header_to_sources = {"foo.h": {"main.cpp", "test.cpp"}, "bar.h": {"main.cpp", "util.cpp"}, "baz.h": {"test.cpp", "other.cpp"}}

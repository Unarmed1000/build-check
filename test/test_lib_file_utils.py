...
class TestFilterHeadersByPattern:
    ...
    def test_wildcard_matching(self, temp_dir: Any) -> None:
        ...
        headers = {
            str(temp_dir / "src" / "math" / "vector.hpp"),
            str(temp_dir / "src" / "graphics" / "renderer.hpp"),
            str(temp_dir / "include" / "api.hpp"),
        }
    ...
    def test_double_wildcard(self, temp_dir: Any) -> None:
        ...
        headers = {
            str(temp_dir / "lib" / "core" / "types.hpp"),
            str(temp_dir / "lib" / "util" / "string.hpp"),
            str(temp_dir / "test" / "unit.hpp"),
        }
    ...
    def test_extension_matching(self, temp_dir: Any) -> None:
        ...
        headers = {
            str(temp_dir / "file1.hpp"),
            str(temp_dir / "file2.h"),
            str(temp_dir / "file3.hxx"),
        }
    ...
    def test_absolute_path_handling(self, temp_dir: Any) -> None:
        ...
        headers = {
            str(temp_dir / "module" / "header.hpp"),
        }
...
class TestClusterHeadersByDirectory:
    ...
    def test_multiple_subdirectories(self, temp_dir: Any) -> None:
        ...
        headers = [
            str(temp_dir / "lib" / "core" / "a.hpp"),
            str(temp_dir / "lib" / "util" / "b.hpp"),
            str(temp_dir / "src" / "main.cpp"),
        ]
    ...
    def test_deep_nesting(self, temp_dir: Any) -> None:
        ...
        headers = [
            str(temp_dir / "a" / "b" / "c" / "d" / "file.hpp"),
            str(temp_dir / "a" / "other" / "file2.hpp"),
        ]
    ...
    def test_single_directory(self, temp_dir: Any) -> None:
        ...
        headers = [
            str(temp_dir / "module" / "a.hpp"),
            str(temp_dir / "module" / "b.hpp"),
            str(temp_dir / "module" / "c.hpp"),
        ]
    ...
    def test_relative_path_outside_project(self, temp_dir: Any) -> None:
        ...
        headers = [
            "/some/absolute/path/header.hpp",
            str(temp_dir / "module" / "header2.hpp"),
        ]
    ...
    def test_preservation_of_order(self, temp_dir: Any) -> None:
        ...
        headers = [
            str(temp_dir / "lib" / "a.hpp"),
            str(temp_dir / "lib" / "b.hpp"),
            str(temp_dir / "lib" / "c.hpp"),
        ]

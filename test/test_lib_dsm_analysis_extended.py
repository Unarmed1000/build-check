...
from lib.dsm_analysis import calculate_matrix_statistics, run_dsm_analysis
...
class TestDSMAnalysisIntegration:
    ...
    def test_run_dsm_analysis_simple_graph(self, mock_dsm_graph_simple: Any) -> None:
        ...
        try:
            ...
            graph_dict = {"A.hpp": set(), "B.hpp": {"A.hpp"}, "C.hpp": {"B.hpp"}, "D.hpp": {"A.hpp"}, "E.hpp": {"B.hpp", "D.hpp"}}

            results = run_dsm_analysis(
                all_headers=set(graph_dict.keys()), header_to_headers=defaultdict(set, graph_dict), compute_layers=True, show_progress=False
            )
    ...
    def test_run_dsm_analysis_with_cycles(self) -> None:
        ...
        try:
            ...
            graph_dict = {"A.hpp": {"B.hpp"}, "B.hpp": {"C.hpp"}, "C.hpp": {"A.hpp"}, "D.hpp": set()}

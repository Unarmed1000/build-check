...
class TestExcludeHeadersByPatterns:
    ...
    def test_exclude_single_pattern(self) -> None:
        ...
        filtered, excluded_count, no_matches = exclude_headers_by_patterns(
    ...
    def test_exclude_by_extension(self) -> None:
        ...
        headers = {
            ...
            "/project/src/generated.h",
            "/project/src/auto_generated.h",
    ...
    def test_exclude_all_headers(self) -> None:
        ...
        headers = {
            "/project/src/ThirdParty/lib1.hpp",
            "/project/src/ThirdParty/lib2.hpp",
        }
        exclude_patterns = ["*/ThirdParty/*"]
        project_root = "/project"
    ...
    def test_exclude_relative_paths(self) -> None:
        ...
        headers = {
            "/home/user/project/src/Engine.hpp",
            "/home/user/project/ThirdParty/lib.hpp",
        }
        exclude_patterns = ["ThirdParty/*"]

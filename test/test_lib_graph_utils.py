...
from lib.graph_utils import (
    ...
    compute_reverse_transitive_closure,
    build_transitive_dependents_map,
    compute_fan_in_fan_out,
    find_hub_nodes,
    compute_betweenness_centrality,
    find_longest_path_through_node,
...
class TestStronglyConnectedComponents:
    ...
    def test_simple_cycle(self) -> None:
        ...
        assert any(len(scc) > 1 for scc in cycles)
...
class TestBuildReverseDependencies:
    ...
    def test_simple_reverse(self) -> None:
        ...
        header_to_headers = {"a.hpp": {"b.hpp"}, "b.hpp": {"c.hpp"}}
        all_headers = {"a.hpp", "b.hpp", "c.hpp"}
    ...
    def test_multiple_dependents(self) -> None:
        ...
        header_to_headers = {"a.hpp": {"c.hpp"}, "b.hpp": {"c.hpp"}}
        all_headers = {"a.hpp", "b.hpp", "c.hpp"}
...
class TestComputeLayers:
    ...
    def test_linear_dependencies(self) -> None:
        ...
        header_to_headers = {"a.hpp": {"b.hpp"}, "b.hpp": {"c.hpp"}, "c.hpp": set()}
        all_headers = {"a.hpp", "b.hpp", "c.hpp"}
    ...
    def test_with_cycle(self) -> None:
        ...
        header_to_headers = {"a.hpp": {"b.hpp"}, "b.hpp": {"a.hpp"}}
...
class TestAnalyzeCycles:
    ...
    def test_no_cycles(self) -> None:
        ...
        header_to_headers = {"a.hpp": {"b.hpp"}, "b.hpp": set()}
        all_headers = {"a.hpp", "b.hpp"}

        cycles, headers_in_cycles, feedback_edges, graph, self_loops = analyze_cycles(header_to_headers, all_headers)
...
class TestBuildTransitiveDependentsMap:
    ...
    def test_simple_dependents(self) -> None:
        ...
        lib_to_libs = {"libA.a": {"libB.a"}, "libB.a": {"libC.a"}, "libC.a": set()}

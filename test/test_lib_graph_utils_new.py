...
from lib.graph_utils import (
    compute_reverse_dependencies, compute_transitive_metrics, compute_chain_lengths,
    identify_critical_headers, compute_pagerank_centrality, calculate_dsm_metrics,
    visualize_dsm, compute_minimum_feedback_arc_set, DSMMetrics
)
...
class TestComputeTransitiveMetrics:
    ...
    def test_simple_transitive_metrics(self) -> None:
        ...
        base_types, trans_deps, reverse_impact = compute_transitive_metrics(
    ...
    def test_transitive_metrics_no_tc(self) -> None:
        ...
        base_types, trans_deps, reverse_impact = compute_transitive_metrics(
            G, None, project_headers, reverse_deps
        )

...
def mock_library_mapping_medium() -> Dict[str, str]:
    ...
    libraries = [("Foundation", 8), ("Core", 6), ("Utils", 5), ("Graphics", 7), ("UI", 6), ("Network", 4), ("Audio", 3), ("Physics", 5), ("AI", 3), ("Game", 3)]
    ...
    for lib in libraries:
        ...
        for i in range(3):
            ...
            compile_commands.append(
                {"directory": str(build_dir), "command": f"g++ -I{src_dir} -c {source} -o {build_dir}/{lib}_file{i}.o", "file": str(source)}
            )
...
def mock_library_boundaries() -> Dict[str, Dict[str, Set[str]]]:
    ...
    """
    return {
        "libCore.a": {"internal": {"Core/base.hpp", "Core/utils.hpp"}, "external": set()},  # Foundation layer, no violations
        "libUI.a": {"internal": {"UI/window.hpp", "UI/button.hpp"}, "external": {"Core/base.hpp", "Graphics/render.hpp"}},  # Allowed
        "libGraphics.a": {
